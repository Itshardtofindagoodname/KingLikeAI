            ...
            <div className="mt-20 container mx-auto p-8 shadow-[-5px_-5px_10px_rgba(255,_255,_255,_0.8),_5px_5px_10px_rgba(0,_0,_0,_0.8)] rounded-lg">
                <div className="flex mb-4 flex-col md:flex-col gap-2">
                    <div className="flex items-center justify-center w-full">
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-neutral-800 hover:bg-neutral-900 transition-colors ease-in-out">
                    ...
                    <div className='flex flex-col md:flex-row w-full mt-4'>
                        <input placeholder='Enter prompt' onChange={(e) => handleChangePrompt(e)} className="mb-2 md:mb-0 p-2 border rounded-md flex-1 text-black" />
