...
const Navbar = ({model}) =>{
    return(
        ...
        <div className="flex flex-row w-full">
            ...
            <span className="text-white text-3xl font-bold text-center md:mr-10 lg:w-80">{model}</span>
            <Link to="/nav" className=" md:mr-10 px-5 py-2 transition ease-in duration-200 uppercase rounded-full text-white hover:bg-neutral-100 hover:text-gray-600 border-2 border-gray-200 focus:outline-none">
                Navigate
            </Link>
        </div>
    </header>
